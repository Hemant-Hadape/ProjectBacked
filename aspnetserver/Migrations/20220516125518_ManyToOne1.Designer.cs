...
namespace aspnetserver.Migrations
{
    ...
    [Migration("20220516125518_ManyToOne1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aspnetserver.Data.KanbanTask", b =>
                {
                    ...
                    b.Property<int>("TaskStatusNavigationStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TaskStatusNavigationStatusId");
            ...
            modelBuilder.Entity("aspnetserver.Data.KanbanTask", b =>
                {
                    ...
                    b.HasOne("aspnetserver.Data.Status", "TaskStatusNavigation")
                        .WithMany("TbTasks")
                        .HasForeignKey("TaskStatusNavigationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("aspnetserver.Data.Project", b =>
                {
                    b.HasOne("aspnetserver.Data.User", null)
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("aspnetserver.Data.ProjectMembers", b =>
                {
                    b.HasOne("aspnetserver.Data.User", "User")
                        .WithMany()
                        .HasForeignKey("UserID");

                    b.HasOne("aspnetserver.Data.Project", "Project")
                        .WithMany()
